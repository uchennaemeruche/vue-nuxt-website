        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-20">
            <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-gray-50 sm:text-7xl">
                ...
                <span class="relative whitespace-nowrap text-blue-600"><svg aria-hidden="true" viewBox="0 0 418 42"
                    ...
                    </svg><span class="relative">made simple</span></span>
                for everyone using QrCode.
            </h1>
            <!-- <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-gray-50 sm:text-7xl">
            ...
            <p class="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-gray-400">
               Quick Response Codes, the most intuitive way to encode and transmit digital information.
            </p>
            <div class="mt-10 flex justify-center gap-x-6">
                <a class="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-blue-600 text-white hover:bg-darkbrown hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900"
                    href="/register">Get 6 months free
                </a>
                <a class="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none ring-slate-200 text-gray-100 hover:text-blue-400 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300"
                    ...
                    </svg><span class="ml-3">Watch video</span>
                </a>
            </div>
